...
async function buildApp(): Promise<FastifyInstance> {
  ...
  // Fastify 5 requires null initial value for object decorators; the actual
  // value is injected per-request via a preHandler hook.
  ...
  app.setErrorHandler((error, _request, reply) => {
    ...
    // biome-ignore lint/suspicious/noExplicitAny: Fastify attaches statusCode to validation errors

...
export const Tool = ({
  ...
  const [hasOpened, setHasOpened] = useState(open ?? (props as any).defaultOpen ?? true);
...
export const ToolContent = ({
  ...
  const resolvedClassName = cn(
    ...
    forceMount && "overflow-hidden data-[state=closed]:max-h-0 data-[state=open]:max-h-[5000px]",
    className,
  );
